...
pub mod kv_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn set(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("ferrium.kv.KvService", "Set"));
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ferrium.kv.KvService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        /// Delete a key
        pub async fn delete(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/ferrium.kv.KvService/Delete");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        ) -> std::result::Result<tonic::Response<super::BatchSetResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/ferrium.kv.KvService/BatchSet");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn list_keys(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/ferrium.kv.KvService/ListKeys");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn exists(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/ferrium.kv.KvService/Exists");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/ferrium.kv.KvService/BatchSet" => {
                    ...
                    impl<T: KvService> tonic::server::UnaryService<super::BatchSetRequest> for BatchSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as KvService>::batch_set(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/ferrium.kv.KvService/ListKeys" => {
                    ...
                    impl<T: KvService> tonic::server::UnaryService<super::ListKeysRequest> for ListKeysSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as KvService>::list_keys(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
